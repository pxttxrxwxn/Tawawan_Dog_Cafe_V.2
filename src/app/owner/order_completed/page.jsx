    ...
    <div className="min-h-screen">
      ...
      <div className="pt-6 pl-6 pr-6">
        <div className="mb-4 mt-[180px] pl-[80px] pr-[80px] flex">
          ...
          <Link
            href="/owner/order_completed"
            className="ml-auto bg-[#0FA958] w-[340px] h-[80px] text-white px-5 py-2 rounded-lg flex items-center cursor-pointer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="48px"
                ...
                <tbody>
                  {orders.map((order, index) => (
                    <tr key={index} className="bg-white">
                      ...
                      <td className="border border-black px-4 py-2">
                        {order.order_description?.map((item, idx) => (
