    ...
    <div className="">
      ...
      <div className="p-6 ">
        <div className="mb-4 mt-[200px] pl-[80px] pr-[80px] flex">
          <div className="w-[454px] h-[99px] p-5 rounded-sm bg-[#FFE7A1] flex items-center text-[#000000]">
            <svg 
              ...
              <div className="flex justify-between mb-2">
                <div className='flex justify-between'>
                  <div className="flex flex-col">
                    <p className="flex items-center gap-2 text-[32px] text-[#000000]">
                      <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      height="32px" 
                      viewBox="0 -960 960 960"
                    ...
                    <span className="text-sm text-black">{order.date} | เวลา: {order.time}</span>
                  </div>
                  <p className="text-[30px] ml-[30px] mt-5 text-[#000000]">โต๊ะ: {order.table}</p>
                </div>
              </div>
