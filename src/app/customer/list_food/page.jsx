...
export default function ListFood() {
  ...
  const handleSelectDrinkMenu = (DrinkMenu) => {
    localStorage.setItem("selectedDrinkMenu", JSON.stringify(DrinkMenu));
  };
              ...
              <div className="w-[80%] mx-auto">
                <div className="grid grid-cols-3 gap-12">
                  {filteredMenus.map((menu) => {
                    const content = (
                      <div className="bg-white rounded-lg shadow-md p-4 mx-10">
