    ...
    <div className="fixed top-0 left-0 w-screen h-[150px] bg-[#FFE8A3] z-50 shadow-md px-6">
      <div className="flex items-center justify-between h-full">
        ...
        <div ref={dropdownRef} className="relative">
          <div
            className="flex items-center space-x-2 cursor-pointer border-black border-2 rounded-md px-4 py-2 min-w-[180px] h-[50px]"
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-40 bg-[#D64545] border border-gray-300 rounded-md shadow-lg z-50">
              <button
                ...
                className="w-full text-left px-4 py-2 text-white font-semibold"
              >
                ออกจากระบบ
              </button>
            </div>
